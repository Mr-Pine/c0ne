...
class TypeCheckAnalysis : NoOpVisitor<List<ReturnTree>> {
    override fun visit(functionTree: FunctionTree, data: List<ReturnTree>) {
        ...
        super.visit(functionTree, listOf())
    }

    override fun visit(returnTree: ReturnTree, data: List<ReturnTree>) {
        super.visit(returnTree, data + listOf(returnTree))
    }

    override fun visit(
        declarationTree: DeclarationTree, data: List<ReturnTree>
    ) {
    ...
    override fun visit(
        assignmentTree: AssignmentTree, data: List<ReturnTree>
    ) {
    ...
    override fun visit(
        binaryOperationTree: BinaryOperationTree, data: List<ReturnTree>
    ) {
    ...
    override fun visit(
        unaryOperationTree: UnaryOperationTree, data: List<ReturnTree>
    ) {
    ...
    override fun visit(ifTree: IfTree, data: List<ReturnTree>) {
    ...
    override fun visit(whileTree: WhileTree, data: List<ReturnTree>) {
    ...
    override fun visit(forTree: ForTree, data: List<ReturnTree>) {
